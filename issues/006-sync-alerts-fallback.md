...
- [x] 驗證：早上已寫，22:29 SKIP（不重複、不覆蓋）→ 晨重優先成立 ✅ 2026-06-01 22:29 台北 log `today_has_row=True -> SKIP`（早筆未被覆蓋；SKIP 與 source 無關，機制成立）。今晚 6/02 22:29「coros 自動晨筆→SKIP」為同機制再現一次
